...
const navigation = [
  { name: 'Endowment Fund', href: '/', current: true },
  { name: 'Create Scholarships', href: '/create-scholarships', current: false },
  { name: 'Apply Scholarships', href: '/apply-scholarships', current: false },
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'bg-gray-100 text-gray-900' : 'text-gray-500 hover:bg-gray-200 hover:text-gray-700',
